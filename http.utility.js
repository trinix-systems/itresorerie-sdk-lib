...
var HttpUtility = /** @class */ (function () {
    function HttpUtility() {
        ...
        try {
            dotenv.config();
            this._HOST = process.env.ITRESORERIE_HOST || "";
            this._APPKEY = process.env.ITRESORERIE_TOKEN || "";
            this._APPMAIL = process.env.ITRESORERIE_USERNAME || "";
            console.log("iTresorerieSDK is initialized to host : " + this._HOST);
        }
        catch (ex) {
            console.log(ex);
        }
